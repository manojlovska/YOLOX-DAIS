...
from visualize_bboxes import visualize_gt
    ...
    for image_path in image_names:
        ...
        for image in annotations_val["images"]:
            if image["file_name"] == filename:
                ...
                for ann_img in annotations_val["annotations"]:
                    if ann_img["image_id"] == img_id:
...
def main(exp, args):
    ...
    predictor = Predictor(
        model, exp, DAIS_CLASSES, trt_file, decoder,
